...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Whaticket SaaS brandx, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar Whaticket SaaS brandx\n"
  # printf "   [1] Atualizar Whaticket SaaS brandx\n"
  printf "   [2] Deletar Whaticket SaaS brandx\n"
  printf "   [3] Bloquear Whaticket SaaS brandx\n"
  printf "   [4] Desbloquear Whaticket SaaS brandx\n"
  printf "   [5] Alter. dominio Whaticket SaaS brandx\n"
  printf "\n"
  read -p "> " option
